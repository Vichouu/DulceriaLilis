...
class Producto(models.Model):
    categoria = models.ForeignKey(Categoria,on_delete=models.PROTECT, related_name='productos',null=True, blank=True,verbose_name='Categoría')
    nombre = models.CharField(max_length=100,verbose_name='Nombre del producto')
    unidad = models.CharField(max_length=2,choices=UNIDADES,default='UN',verbose_name='Unidad')
...
class Lote(models.Model):
    ...
    fecha_vencimiento = models.DateField(null=True,blank=True,db_index=True,verbose_name='Fecha de vencimiento')
